...
print('API token is:', HF_API_TOKEN)
...
def plot_bias_gauge(bias_left, bias_center, bias_right):
    bias_score = bias_right - bias_left  # -1 (Left) to +1 (Right)
...
def main():
    ...
    if st.button("Fetch Video Data"):
        ...
        try:
            ...
            # ✅ Define transcript for use in FLAN and prompt
            transcript = existing_analysis.caption_text
            ...
            st.write("Metadata contents:", metadata)
